...
class RandomWalk5Env(gym.Env):
    ...
    def __init__(self):
        ...
        self.true_values = [0, 1 / 6, 2 / 6, 3 / 6, 4 / 6, 5 / 6, 0]
    ...
    def step(self, action):
        ...
        terminated = self._agent_location == 0 or self._agent_location == 6
        reward = (0 if self._agent_location == 0 else 1) if terminated else 0
