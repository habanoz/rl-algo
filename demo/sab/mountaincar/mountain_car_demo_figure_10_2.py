...
def start():
    ...
    agents = [
        lambda: EpisodicSemiGradientSarsaAgent(AgentTrainingConfig(epsilon=0, gamma=1.0, alpha=0.1), n_actions,
                                               n_states, state_scale, n_tilings),
        lambda: EpisodicSemiGradientSarsaAgent(AgentTrainingConfig(epsilon=0, gamma=1.0, alpha=0.2), n_actions,
                                               n_states, state_scale, n_tilings),
        lambda: EpisodicSemiGradientSarsaAgent(AgentTrainingConfig(epsilon=0, gamma=1.0, alpha=0.5), n_actions,
                                               n_states, state_scale, n_tilings),
    ]
